...
export default function App() {
  return (
    <div className="max-w-xl mx-auto bg-orange-300 min-h-screen">
      ...
      <form className = "flex"><input type="text" placeholder="Task Name" className=" mx-2 bg-gray-100"/></form>
            <form className = "flex"><input type="text" placeholder="Task Description" className=" m-2 bg-gray-100"/></form>
      <button type="submit" className = "m-2 p-1 bg-gray-200 pointer">Submit</button>
      </div>
      {TaskData.map((task) =>{
